...
function renderSecondaryMenu(menu) {
  if (menu.children && menu.children.length > 1) {
    var str = "<hr><input type=\"checkbox\" id=\"subnav-toggle\"><label for=\"subnav-toggle\"><h6>".concat(menu.title, "</h6></label><div class=\"subnav-content\"><ul>");
...
/* harmony import */ var lit_directives_style_map_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! lit/directives/style-map.js */ "./node_modules/lit/directives/style-map.js");
...
var IbpHeader = /*#__PURE__*/function (_LitElement) {
  ...
  function IbpHeader() {
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_4__.fetchData)().then(function (res) {
      ...
      if (current.hero && typeof _this.background_image !== "undefined") {
      ...
      window.setTimeout(function () {
        var subnavToggle = _this.shadowRoot.querySelector("label[for=subnav-toggle]");
  ...
  _createClass(IbpHeader, [{
    ...
    value: function render() {
      ...
      }), this._getSidebar(), this.current_menu.title, (0,lit_directives_unsafe_html_js__WEBPACK_IMPORTED_MODULE_2__.unsafeHTML)(this.current_menu.description)) : null, this._hideMenuOverlay, this.show_menu, this.primary_menu);
    }
  }]);
  return IbpHeader;
}(lit__WEBPACK_IMPORTED_MODULE_0__.LitElement);
...
/* harmony export */ });
var checkURL = function checkURL(testString, testArray) {
  return testArray.some(function (v) {
    return testString.indexOf(v) > -1;
  });
};
