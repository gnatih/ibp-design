...
function renderFullMenu(menu) {
  var str = ""; // let menu_items = [menu.slice(0, 2), menu.slice(2, menu.length - 4), menu.slice(menu.length - 4, menu.length)]; //pre-launch
...
var IbpFooter = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(IbpFooter, [{
    ...
    value: function firstUpdated() {
      ...
      var nb = this.shadowRoot.querySelector("footer");
...
var FeaturedStory = /*#__PURE__*/function (_LitElement) {
  ...
  _createClass(FeaturedStory, [{
    key: "render",
    value: function render() {
      return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["<div class=\"story-image\" style=\"background: url(", ") center/cover no-repeat\"></div>\n      <div class=\"story-content\">\n        <p class=\"featured-type\">", "</p>\n        <h3>", "</h3>\n        <a href=\"", "\" class=\"read-more\">", " <i class=\"ibp-icons icon-caret-right-circle\"></i></a>\n      </div>"])), this.featured["featured_image"], this.featured["featured_type"], this.featured["featured_title"], this.featured["featured_link"], this.featured["featured_button_text"]);
    }
  }], [{
    key: "styles",
    get: function get() {
